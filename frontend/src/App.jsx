      ...
      <section className="px-12 py-16 min-h-[calc(100vh-4rem)]">
        ...
        <div className="grid gap-10 grid-cols-1 md:grid-cols-2">
          {services.map((s) => (
            <div
              key={s.title}
              className="bg-[#145374] cursor-pointer rounded-3xl p-8 shadow-xl hover:shadow-2xl transition duration-300 flex flex-col md:flex-row items-center gap-6 hover:scale-[1.02]"
            >
              <img
                src={s.img}
                alt={s.title}
