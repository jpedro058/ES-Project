...
ALLOWED_HOSTS = ['django-env.eba-cfca3zhn.us-east-1.elasticbeanstalk.com', '127.0.0.1', 'localhost', 'django-env.eba-gmvprtui.us-east-1.elasticbeanstalk.com', "https://es-project.jplaranjeiro.dev"]
